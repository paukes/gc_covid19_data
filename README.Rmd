...
**Update:** A colleague just forwarded me an excellent group that is already doing this, and have developed some great RShiny apps to visualize the data. You can find it here: https://art-bd.shinyapps.io/covid19canada/ . I would highly recommend this site as it contains more detailed and up-to-date information. I'll still continue to add data whenever I have a chance, but do check out that website as they supply open-sourced data as well.
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.height=12}
library(tidyverse)
library(patchwork)
library(rcartocolor)
library(scales)
...
tot_case <- 
  ...
  labs(title='Total Confirmed Cases For Different Provinces',
       subtitle='Data current as of 18:00 March 23, 2020',
       y='Confirmed Cases', 
       colour='Province')+
  theme_classic()+
